            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('updatePromo',$promo->id) }}" enctype="multipart/form-data" id="addpromo">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name')??$promo->name }}"  autocomplete="name" placeholder="Promo name" autofocus>
                            ...
                            <label for="ingredients" class="label_class">Description</label>
                             <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative">
                                    ...
                                    <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description')??$promo->description }}"  autocomplete="description" placeholder="Promo Description" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input id="discount" type="text" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ old('discount')??$promo->discount }}"  autocomplete="discount" placeholder="Discount(%)" autofocus>
