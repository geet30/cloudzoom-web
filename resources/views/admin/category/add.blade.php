                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('saveCategory') }}" enctype="multipart/form-data" id="addCategory">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control @error('category_name') is-invalid @enderror" name="category_name" value="{{ old('category_name') }}"  autocomplete="category_name" placeholder="Category name" autofocus>
